...
bool canPush(std::uint32_t state, const FixedWorld&, BlockPos pos, const Facing& facing,
...
PistonStructureHelper::PistonStructureHelper(const FixedWorld& world, BlockPos pistonPos,
