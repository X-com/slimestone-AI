...
EXE="$ROOT/build/gpu_kernel_stream"
...
# conversion step needed, just pass it straight to file mode as one input. Unlike
# gpu_simulator_stream (reference/, CPU), this is the actual GPU-executed engine
# (src/kernel/, Milestone I persistent work-queue dispatch) - see README.md for what it
# has/hasn't been validated on.
set +e
"$EXE" "$FLYERS_FILE"
exit_code=$?
set -e
